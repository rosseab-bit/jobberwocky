"""
URL configuration for jobberwocky project.
...
schema_view = get_schema_view(
   openapi.Info(
      title="Job API",
      default_version='v1',
      description="API for managing job listings and user subscriptions",
      terms_of_service="https://mycompany.com/terms",
      contact=openapi.Contact(email="support@mycompany.com"),
